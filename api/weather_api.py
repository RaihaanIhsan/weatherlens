...
def fetch_live_weather(city_name: str) -> Optional[WeatherData]:
    ...
    params = {
        ...
        "current": (
            ...
            "windspeed_10m,visibility,relativehumidity_2m,"
            "cloudcover,snowfall"
        ),
        "timezone": "auto",
    }
    ...
    data.apparent_temperature = current.get("apparent_temperature", data.temperature)
    data.cloudcover           = current.get("cloudcover", 0)
    data.snowfall             = current.get("snowfall", 0)
